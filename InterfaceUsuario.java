...
public class InterfaceUsuario {
    ...
    // Recebe um objeto Log, que provavelmente contém uma lista de eventos.
    public void mostrarLogs(Log log) {
        log.exibirEventos();  // Chama o método exibirEventos() da classe Log para exibir os eventos registrados.
    }
